...
describe('POST /auth/oauth/v2/token', ()=> {
  ...
  it('token generated with success', ()=> {
  ...
  it('token generated without success - Unauthorized', ()=> {
  ...
  it('token generated without success - Invalid data', ()=> {
  ...
  it('token generated with success - Different Scope', ()=> {
